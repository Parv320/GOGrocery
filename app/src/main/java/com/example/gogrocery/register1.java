...
import app.infiniverse.grocery.ValidateOTP;
        ...
        class LoadCitySpinner extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(com.example.gogrocery.RegisterActivity.this, android.R.layout.simple_spinner_item, city_list);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    city.setAdapter(adapter);
                } catch (Exception e) {
                    Toast.makeText(com.example.gogrocery.RegisterActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                }
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((!name.equals("")) && (!email.equals("")) && (!mobile.equals("")) && (!address.equals("")) && (!city_id.equals("")) && (!locality_id.equals("")) && (!password.equals("")) && (!cpassword.equals(""))) {
                    ...
                    if (ActivityCompat.checkSelfPermission(com.example.gogrocery.RegisterActivity.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(com.example.gogrocery.RegisterActivity.this);
                        ...
                        if(!cpassword.equals(password)) {
                            Toast.makeText(com.example.gogrocery.RegisterActivity.this, "Password Didn't Matched", Toast.LENGTH_SHORT).show();

                        }else if(!mobile.matches("[0-9]{10}"))
                        {
                            Toast.makeText(com.example.gogrocery.RegisterActivity.this, "Enter Valid Number", Toast.LENGTH_SHORT).show();
                        }else if(!email.matches("[a-zA-Z0-9._-]+@[a-z]+\\.+[a-z]+"))
                        {
                            Toast.makeText(com.example.gogrocery.RegisterActivity.this, "Enter Valid Email Address", Toast.LENGTH_SHORT).show();
                        }
                        else registerUser();
                    }
                }else{
                    Toast.makeText(com.example.gogrocery.RegisterActivity.this, "All Fields Are Mandatory", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            class LoadLocalitySpinner extends AsyncTask<Void, Void, String> {
                ...
                protected void onPostExecute(String s) {
                    ...
                    try {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(com.example.gogrocery.RegisterActivity.this, android.R.layout.simple_spinner_item, locality_list);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void registerUser() {
        ...
        if ((!name.equals("")) && (!email.equals("")) && (!mobile.equals("")) && (!address.equals("")) && (!city_id.equals("")) && (!locality_id.equals("")) && (!password.equals(""))) {
            try {
                ...
                Intent intent=new Intent(com.example.gogrocery.RegisterActivity.this, ValidateOTP.class);
                ...
                Toast.makeText(com.example.gogrocery.RegisterActivity.this, "MSG Can not sent Check Your Balance", Toast.LENGTH_SHORT).show();
            }
